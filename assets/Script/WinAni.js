cc.Class({
    ...
    aniStart: function(){
        ...
        let action_1 = cc.moveBy(3, cc.p(0, moveDes));        
        let action_2 = cc.moveBy(3.1, cc.p(0, moveDes));//cc.easeElasticOut(3.0)
        let action_3 = cc.moveBy(3.25, cc.p(0, moveDes));
        let action_4 = cc.moveBy(3, cc.p(0, moveDes));
        let action_5 = cc.moveBy(3.25, cc.p(0, moveDes));
        let action_6 = cc.moveBy(3.25, cc.p(0,moveDes));
        let action_7 = cc.moveBy(3, cc.p(0, moveDes));
        let action_8 = cc.moveBy(3, cc.p(0, moveDes));
        let action_9 = cc.moveBy(3, cc.p(0, moveDes));
        let action_10 = cc.moveBy(3, cc.p(0, moveDes));
        let action_12 = cc.moveBy(3, cc.p(0, moveDes));//cc.easeElasticOut(3.0
        let action_13 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action_14 = cc.moveBy(3, cc.p(0, moveDes));
        let action_15 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action_16 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action_17 = cc.moveBy(3, cc.p(0, moveDes));   
        let action_18 = cc.moveBy(3, cc.p(0, moveDes));
        let action_19 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_1 = cc.moveBy(3, cc.p(0, moveDes));        
        let action1_2 = cc.moveBy(3.1, cc.p(0, moveDes));//cc.easeElasticOut(3.0)
        let action1_3 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action1_4 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_5 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action1_6 = cc.moveBy(3.1, cc.p(0,moveDes));
        let action1_7 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_8 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_9 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_10 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_12 = cc.moveBy(3, cc.p(0, moveDes));//cc.easeElasticOut(3.0
        let action1_13 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action1_14 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_15 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action1_16 = cc.moveBy(3.1, cc.p(0, moveDes));
        let action1_17 = cc.moveBy(3, cc.p(0, moveDes));   
        let action1_18 = cc.moveBy(3, cc.p(0, moveDes));
        let action1_19 = cc.moveBy(3, cc.p(0, moveDes));  
