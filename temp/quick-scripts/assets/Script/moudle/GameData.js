(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/moudle/GameData.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '899c23LXUhI6rq2cZd32fl3', 'GameData', __filename);
...
var GameListData = cc.Class({
    properties: {
        ...
        no: "", //订单号
        bonusAmount: 0, //总奖金
        status: 0 //状态，0：游戏中（等待开奖），1：中奖，2：未中奖   
    }
});
...
var InitData = cc.Class({
    ...
    // parseOrderResult:function(data) {
    //     if (data == null || data == undefined  || data == "") { 
    //             return;
    //     }
    //     var orderResultList=[];
    ...
    //         lineResult.amount=data[i].amount;
    //         lineResult.locations=data[i].locations;
    //         lineResult.num=data[i].num;
    //         lineResult.picCode=data[i].picCode;
    //         orderResultList.push(lineResult);
    //     }
