(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/JiangChi.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e0b95wN85hPEqrPaZ8wReoy', 'JiangChi', __filename);
// Script/JiangChi.js
...
cc.Class({
    ...
    setDetailArrayString: function setDetailArrayString() {
        ...
        for (var i = 0; i < this.detailArray.length; i++) {
            ...
            Common.Common.getInst().getNick(j, uid, function (jj, nick, uidCopy) {
                //异步的
                var newId = "$" + uidCopy + "$";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=JiangChi.js.map
