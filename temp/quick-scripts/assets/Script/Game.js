...
cc._RF.push(module, 'e6c82VRx7BHDJ87sOLeh+Ew', 'Game', __filename);
// Script/Game.js
...
cc.Class({
    ...
    netCallback: function netCallback(cmd, res, msg, self) {
        ...
        if (res == 0) {
            ...
            if (cmd == 104) {
                ...
                if (cmd == 103) {
                    var _s2 = self.orderNode.getComponent("JiluListScript");
                    _s2.errorCallBack();
                }
            }
        }
    ...
    openControl: function openControl() {
        ...
        // }//规则出来了点不了奖池奖
        var node = cc.find("Canvas/poolRule");
        var s3 = node.getComponent("PoolRule");
        if (s3.hasOpen == true) {
            s3.close();
        }
    },
    ...
    test: function test(type) {
        ...
        if (type == 'rule') {
            var _s3 = self.helpNode.getComponent("Help");
            if (NetData.NetData.getInst().orderShowFlag) {
