(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/JiluListScript.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '10c90r4USJN17MFsR0Fpzmn', 'JiluListScript', __filename);
...
cc.Class({
    ...
    close: function close(closeCallback, closeType) {
        if (!this.lock) {
            ...
            var call3 = cc.callFunc(function () {
                ...
                if (closeType == 2) {
                    if (window.aliLotteryCasinoSDK) {
                        window.aliLotteryCasinoSDK.throwTimer('hideSheet', 'order');
                    }
                } else if (closeType == 1) {
    ...
    initList: function initList() {
        ...
        if (oLen > this.contenCount) {
            ...
            this.moreSprite.y = -(jj_height - 24) * this.scaleValue + 15;
        } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=JiluListScript.js.map
