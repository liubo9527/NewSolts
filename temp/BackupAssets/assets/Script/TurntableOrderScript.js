cc.Class({
    ...
    setOrderData:function(time_label, number_label, dou_label,state_Label, stateInt,  dou_currency)
    {
        this.timeLabel.string = time_label;
        this.numberLabel.string = "订单编号：" + number_label;
        this.douLabel.string = "投:    " + dou_label; //+ dou_currency;
        ...
        else if(stateInt == 1)
        {
            ...
            this.stateLabel.string = "中:    " + state_Label;//+ dou_currency;
            
            this.satateDou.active = true;
